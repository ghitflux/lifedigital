...
export type MargemStackScreenProps<T extends keyof MargemStackParamList> = StackScreenProps<
  MargemStackParamList,
  T
>

export type DocumentosStackScreenProps<T extends keyof DocumentosStackParamList> = StackScreenProps<
  DocumentosStackParamList,
  T
>

export type PerfilStackScreenProps<T extends keyof PerfilStackParamList> = StackScreenProps<
